...
import jsIcon from '../assets/img/icon-js.svg';
    ...
    return (
        <div>
            ...
            <div className="flex flex-row flex-wrap justify-center mb-16">
                <img className="programming-icons m-3" src={htmlIcon} alt=""/>
                <img className="programming-icons m-3" src={reactIcon} alt=""/>
                <img className="programming-icons m-3" src={cssIcon} alt=""/>
                <img className="programming-icons m-3" src={gitIcon} alt=""/>
                <img className="programming-icons m-3" src={jsIcon} alt=""/>
            </div>
